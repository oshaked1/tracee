...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		StackUnwindSysExecveRet:     NewTraceProbe(SyscallExit, "execve", "trace_ret_sys_execve_stack_unwind"),
		StackUnwindSysExecveatRet:   NewTraceProbe(SyscallExit, "execveat", "trace_ret_sys_execve_stack_unwind"),
		StackUnwindMmapRegion:       NewTraceProbe(KProbe, "mmap_region", "trace_mmap_region_stack_unwind"),
		StackUnwindMmapRegionRet:    NewTraceProbe(KretProbe, "mmap_region", "trace_ret_mmap_region_stack_unwind"),
		StackUnwindSysMunmap:        NewTraceProbe(SyscallEnter, "munmap", "sys_munmap_stack_unwind"),
		StackUnwindSchedProcessExit: NewTraceProbe(RawTracepoint, "sched:sched_process_exit", "sched_process_exit_stack_unwind"),
		ExecStackTrace:              NewTraceProbe(KProbe, "security_bprm_check", "generate_exec_stack_trace"),
