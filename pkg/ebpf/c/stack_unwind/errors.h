#ifndef __STACK_UNWIND_ERRORS_H__
#define __STACK_UNWIND_ERRORS_H__
...
typedef enum ErrorCode {
    ...
    // Maximum concurrent stack unwinds
    ERR_MAX_CONCURRENT = 6,

    // Invalid program type
    ERR_INVALID_PROGRAM_TYPE = 7,

    // Not in task context
    ERR_CONTEXT = 8,

    // Bad unwinder program index
    ERR_BAD_UNWINDER = 9,
    ...
    // Native: Unexpectedly encountered an instruction pointer of zero
...
#endif // __STACK_UNWIND_ERRORS_H__