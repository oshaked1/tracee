...
var kernelConfigKeyStringToID = map[string]KernelConfigOption{
	...
	"CONFIG_CRASH_CORE":               CONFIG_CRASH_CORE,
	"CONFIG_VMCORE_INFO":              CONFIG_VMCORE_INFO,
	"CONFIG_PROC_KCORE":               CONFIG_PROC_KCORE,
	"CONFIG_KALLSYMS":                 CONFIG_KALLSYMS,
	"CONFIG_KALLSYMS_ALL":             CONFIG_KALLSYMS_ALL,
	"CONFIG_SLAB":                     CONFIG_SLAB,
	"CONFIG_SLOB":                     CONFIG_SLOB,
	"CONFIG_SLUB":                     CONFIG_SLUB,
	"CONFIG_SLUB_CPU_PARTIAL":         CONFIG_SLUB_CPU_PARTIAL,
	"CONFIG_SLUB_TINY":                CONFIG_SLUB_TINY,
	"CONFIG_SLUB_DEBUG":               CONFIG_SLUB_DEBUG,
	"CONFIG_SLUB_DEBUG_ON":            CONFIG_SLUB_DEBUG_ON,
	"CONFIG_PAGE_SHIFT":               CONFIG_PAGE_SHIFT,
	"CONFIG_ARM64_PAGE_SHIFT":         CONFIG_ARM64_PAGE_SHIFT,
	"CONFIG_X86_5LEVEL":               CONFIG_X86_5LEVEL,
